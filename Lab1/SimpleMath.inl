...
inline DirectX::SimpleMath::Rectangle Rectangle::Intersect(const Rectangle& ra, const Rectangle& rb) noexcept
{
...
inline DirectX::SimpleMath::Rectangle Rectangle::Union(const Rectangle& ra, const Rectangle& rb) noexcept
{
    const long righta = ra.x + ra.width;
    const long rightb = rb.x + rb.width;
...
inline Matrix Matrix::CreateShadow(const Vector3& lightParam1, const Plane& plane) noexcept
{
    using namespace DirectX;
    const XMVECTOR light = XMLoadFloat3(&lightParam1);
